...
-- Create enum for learning path categories
...
-- RLS Policies for learning_paths (public read, admin write)
CREATE POLICY "Learning paths are publicly readable" ON public.learning_paths
  FOR SELECT USING (true);

-- RLS Policies for learning_path_courses (public read, admin write)  
